...
#include "jackal_info_gain/frenet_planner/FrenetPath.h"
...
public:
    FrenetOptimalTrajectory(FrenetHyperparameters &);
    ...
    FrenetHyperparameters getHyperParams();
private:
    FrenetInitialConditions *_fot_ic;
    FrenetHyperparameters _fot_hp;
    mutex *mu;
